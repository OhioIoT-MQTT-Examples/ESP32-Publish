...
## Overview
This is the beginning of a library for you to connect your ESP32 to your new MQTT broker (Mosquitto).  The code is explained in the YouTube video [MQTT - ESP32 Publish Using PubSubClient.h](https://www.youtube.com/watch?v=Jgq480yQDJo).
